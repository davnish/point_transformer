...
python train.py --epoch 100 --eval $eval --lr 0.00007 --dp 0.2 --step_size 25 --points_taken 4096 --batch_size 16 --grid_size 25 --model_name $model_name --model PCT_FPMOD --load_checkpoint True
python train.py --epoch 100 --eval $eval --lr 0.00005 --dp 0.1 --step_size 25 --points_taken 4096 --batch_size 16 --grid_size 25 --model_name $model_name --model PCT_FPMOD --load_checkpoint True
